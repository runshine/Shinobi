...
module.exports = function(s,config,lang,app,io){
    ...
    s.createTimelapseFrameAndInsert = function(e,location,filename,eventTime,frameDetails){
        ...
        if(config.childNodes.enabled === true && config.childNodes.mode === 'child' && config.childNodes.host && config.dropTimeLapseFrames === false){
        ...
        }else if (config.dropTimeLapseFrames === false ){
